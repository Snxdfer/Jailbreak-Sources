...
local function AHIR_fake_script() -- JailbreakGUI.LocalScript 
	...
	if game.PlaceId == 606849621 then
		...
		if not _G.RedsJBGUI then
			...
			loadstring(game:HttpGet("https://raw.githubusercontent.com/Snxdfer/Jailbreak-Sources/refs/heads/main/RedWire/ImportantFunctions.lua"))()
			...
			singleclick(mainframe.aimbot, function()
				loadstring(game:HttpGet("https://raw.githubusercontent.com/Snxdfer/Jailbreak-Sources/refs/heads/main/RedWire/Aimbot.lua"))()
